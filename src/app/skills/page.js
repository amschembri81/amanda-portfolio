export default function Skills() {
  return (
    <section id="skills" className="bg-gray-900 text-white py-12 px-6 pt-32">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {/* Featured Skills */}
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-400">Featured Skills</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-2 text-gray-400">Core Technical Skills</h3>
            <ul className="list-disc list-inside text-gray-300 space-y-2">
